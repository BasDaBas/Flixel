...
{
	public var speed:Float = 350; //speed of the player
	private var _sndStep:FlxSound;
	
	public function new(X:Float=0, Y:Float=0) 
	{
		super(X, Y);
		//This tells your sprite to use the player.png graphic, that it's animated, and that each frame is 54x16 pixels
		loadGraphic(AssetPaths.player__png, true, 54, 54);
	...
	//function that will be updated everyfram
