 ...
 
{
	...
	{
		//setup the map
		_map = new FlxOgmoLoader(AssetPaths.room_004__oel);	// setup level
			
		_mWalls = _map.loadTilemap(AssetPaths.Tilesheet1__png, 54, 54, "walls");	//setup tiles	
		...
		_mWalls.setTileProperties(5, FlxObject.NONE);	//set tile  to ANY collide	
		...
		_mWalls.setTileProperties(10, FlxObject.NONE);	//set tile  to ANY collide	
		_mWalls.setTileProperties(11, FlxObject.NONE);	//set tile  to ANY collide	
		
		
		_mWalls.setTileProperties(13, FlxObject.ANY);	//set tile  to ANY collide		
		_mWalls.setTileProperties(14, FlxObject.ANY);	//set tile  to ANY collide
		_mWalls.setTileProperties(15, FlxObject.ANY);	//set tile  to ANY collide
		add(_mWalls);		
		...
		FlxG.sound.destroy;
		FlxG.sound.playMusic(AssetPaths.soundtracklevel2__wav,1,true);
		//setup cards
